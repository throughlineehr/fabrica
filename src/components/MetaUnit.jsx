...
import { RoundedRectOutline, RoundedRectFill } from './RoundedRectOutline'
...
export function MetaUnit({ x = 0, layer = 0, nodeId, onContextMenu, onDoubleClick, onSystemClick, onHover, dimmed, hasS2 = false, isPaneView = false }) {
